 ...
 *      Modified for LCCWin32 compiler by Robert Wishlaw 2002/11/23
 */
...
*
* \file            Lesson08.c
* \author          Tom Stanis & Jeff Molofee ( NeHe ) originely, Modified for LCCWin32 compiler by Robert Wishlaw 2002/11/23
* \author          After adapted by Thierry Dechaize to verify paradigm : one source for multiple C Compilers
* \version         1.0.1.2
* \date            23 décembre 2015
* \brief           Ouvre une simple fenêtre Windows et dessine un cube avec un blending grace à un fichier BITMAP avec une rotation obtenue par les flêches du clavier.
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!NeHeLoadBitmap3("../../Data/Glass.bmp", texture))		// Load The Bitmap
		return FALSE;
